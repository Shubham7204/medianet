  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      type: "bot",
      content: "🎯 **Welcome to MediaNet Prediction AI!**\n\nI can help you with keyword analysis and marketing predictions. Use the **Keyword Analysis** button to get started with comprehensive keyword research and market insights!",
      timestamp: new Date(),
    },
  ])
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex space-x-6">
                ...
                <span className="text-accent font-medium">Predict</span>
              </div>
            </div>
